...
# Choose the method to print data - http://www.last.fm/api/show/user.getRecentTracks
...
### Recent track parameters: 
## UNIX timestamp conversion: http://www.epochconverter.com/
# from date - March 15, 5:00am
fromDate = '1458032400'

# to date - March 30, 5:00am
toDate = '1459328400'
...
with open(PAIRS_IN, 'rb') as csvfile:
    ...
    for row in reader: 
        ...
        lastfm_url = "http://ws.audioscrobbler.com/2.0/?method=" + method + "&user=" + user + "&from=" + fromDate + "&to=" + toDate + "&limit=" + str(limit) + "&api_key=57ee3318536b23ee81d6b27e36997cde&format=json"
